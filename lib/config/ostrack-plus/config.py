...
cfg.MODEL.BACKBONE.STUDENT_PRETRAIN_FILE = "/data/yinhf/project/OSTrack/output/checkpoints/train/ostrack/fe108_stack_bs32/OSTrack_ep0300.pth.tar"
cfg.MODEL.BACKBONE.TEACHER_PRETRAIN_FILE = "/data/yinhf/project/OSTrack/output/checkpoints/train/ostrack/fe108_rgb_bs32/OSTrack_ep0300.pth.tar"
