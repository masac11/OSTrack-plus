...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        ...
        if name == "FE108Rgb":
            datasets.append(FE108Rgb(settings.env.fe108_rgb_dir, split='train', image_loader=image_loader))
        # if name == "FE108Neg":
        #     datasets.append(FE108Neg(settings.env.fe108_stack_dir, split='train', image_loader=image_loader))
        # if name == "FE108Voxel":
        #     datasets.append(FE108Voxel(settings.env.fe108_stack_dir, split='train', image_loader=image_loader))
        if name == "LASOT":
