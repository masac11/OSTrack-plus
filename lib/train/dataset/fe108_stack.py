...
class FE108Stack(BaseVideoDataset):
    """ GOT-10k dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        """
        root = env_settings().fe108_stack_dir if root is None else root
        super().__init__('FE108Stack', root, image_loader)
    ...
    def _get_frame_path(self, seq_path, frame_id):
        return os.path.join(seq_path, 'stack', '{:05}.jpg'.format(frame_id+1))    # frames start from 1
